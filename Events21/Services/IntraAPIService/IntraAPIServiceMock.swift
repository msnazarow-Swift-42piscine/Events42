...
//
//    lazy var me = UserFullModel(id: 0, firstName: "FirstName", lastName: "LastName", imageUrl: "https://purr.objects-us-east-1.dream.io/i/capture.png", login: "sgertrud", cursusUsers: [cursusUser], campus: [campus])
//
//	let user = UserShortModel(id: 0, firstName: "FirstName", lastName: "LastName", url: "https://example.com", login: "sgertrud", createdAt: Date().byAddingDay(-720), email: "example@example.com", imageUrl: "https://example.com", poolMonth: "January", poolYear: "2020", staff: false, phone: "+898880988", location: "Moscow")
//
